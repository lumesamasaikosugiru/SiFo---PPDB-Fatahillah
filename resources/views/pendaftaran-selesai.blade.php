...
@section('content')
  ...
  {{-- Hero --}}
  <section
    class="min-h-screen bg-gradient-to-br from-primary-700 via-primary-600 to-teal-500 flex items-center justify-center px-4 py-20">
      ...
      <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div class="p-8 md:p-12">
          ...
          <div class="text-center mb-8">
            <div
              class="w-24 h-24 bg-green-50 rounded-full flex items-center justify-center mx-auto mb-5 border-4 border-green-100">
          ...
          <div class="bg-gradient-to-r from-primary-600 to-primary-800 rounded-2xl p-6 text-center text-white mb-8">
            ...
            <div class="flex items-center justify-center gap-3 my-1">
              <p class="text-4xl font-extrabold tracking-widest font-mono" id="kode-pendaftaran">
                {{ $pendaftaran->kode_regis }}</p>
              <button onclick="salinKode('kode-pendaftaran', this)" title="Salin kode"
                ...
                {{-- icon copy --}}
                <svg id="icon-copy-kode-pendaftaran" class="w-4 h-4 text-white group-hover:scale-110 transition-transform"
                  fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round"
                    d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
                {{-- icon check (hidden) --}}
                <svg id="icon-check-kode-pendaftaran" class="w-4 h-4 text-green-300 hidden" fill="none"
          ...
          <div class="flex items-center gap-3 bg-yellow-50 border border-yellow-200 rounded-2xl px-5 py-4 mb-6">
            ...
            <div>
              ...
              <p class="text-xs text-yellow-600 mt-0.5">Panitia PPDB akan memverifikasi data dan dokumen Anda dalam
